...
// Stripe webhook needs raw body - apply raw parser BEFORE any other body parsers
app.use('/api/v1/payments/webhook/stripe', express.raw({ type: 'application/json' }));

// Cookie parser middleware (after webhook raw parser)
